...
O `ggplot2` pode interagir com os outros pacotes que compõem o `tidyverse`. Por exemplo, podemos 

FALAR SOBRE A INTERAÇÃO COM O DPLYR - GRAFICO DE BARRAS COM E SEM DPLYR, TESTAR O FILTER!

EXERCICIO: MONTAR FIGURAS DESCREVENDO OS PADRÕES GERAIS OBTIDOS NA LIMPEZA DAQUELES DADOS ANTERIORES!

FALAR SOBRE COMO SALVAR UM GRÁFICO DO GGPLOT

SE DER TEMPO: GGMAP E CRIANDO CORES!
