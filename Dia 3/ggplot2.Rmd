...
```{r}
qplot(x = conc, y = uptake, data = CO2)
```
...
1. Construa um gráfico da relação entre o ano e o GDP para cada continente;  
2. Construa um gráfico com a distribuição de expectativa de vida para cada continente;  
3. Construa um gráfico com a distribuição de expectativa de vida.  
